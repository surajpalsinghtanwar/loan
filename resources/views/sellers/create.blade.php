...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{translate('Agents Information')}}</h3>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" placeholder="{{translate('Phone Number')}}" id="phone" name="phone" class="form-control" required>
                    </div>
                </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="email">{{translate('Address')}}</label>
                    <div class="col-sm-9">
                        <textarea type="text" placeholder="{{translate('Address')}}" id="address" name="address" class="form-control" required rows="4"></textarea>
                    </div>
                </div>              
                 <div class="form-group">
                    <label class="col-sm-3 control-label" for="password">{{translate('profile')}}</label>
                    <div class="col-sm-9">
                        <input type="file"  id="password" name="profile" class="form-control" required>
                    </div>
                </div>
            </div>
