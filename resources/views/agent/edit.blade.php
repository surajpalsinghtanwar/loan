...
<div class="col-lg-12 col-md-12 col-sm-12">
    <div class="panel">
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('agent.update',$agent->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
                    ...
                    <div class="col-md-4">                     
                        <div class="form-group">
                            ...
                            <select name="gender" class="form-control"> 
                                    ...
                                    <option value="male" <?php if($agent->gender=='male'){echo "selected";}?>>Male</option>
                                     <option value="female" <?php if($agent->gender=='female'){echo "selected";}?>>female</option>
                            </select>                          
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                ...
                                <option value="loan" <?php if($agent->gender=='loan'){echo "selected";}?>>loan</option>
                                 <option value="rd" <?php if($agent->gender=='rd'){echo "selected";}?>>Rd</option>
                            </select>   
